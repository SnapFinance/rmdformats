...
readthedown_uk <- function(fig_width = 8,
                        fig_height = 5,
                        fig_caption = TRUE,
                        highlight = "kate",
                        lightbox = FALSE,
  ...
  html_template(
    ...
    template_dependencies = list(
      html_dependency_readthedown_uk(embed_fonts)
    ),
...
html_dependency_readthedown_uk <- function(embed_fonts = TRUE) {
  stylesheets <- "readthedown_uk.css"
  if (embed_fonts) {
  ...
  htmltools::htmlDependency(name = "readthedown",
                            version = "0.1",
                            src = system.file("templates/readthedown_uk", package = "rmdformats"),
